#!/bin/bash
# Launch the GTA5 bridge container on NVIDIA Jetson.
#
# Usage:
...
#   IMAGE_TAG      - Docker image tag (default: gta-bridge-l4t)
...
IMAGE_TAG="${IMAGE_TAG:-gta-bridge-l4t}"
...
echo "Starting GTA5 bridge on Jetson..."
...
exec docker run -it --rm \
    ...
    -e SIMULATION=1 \
    -e NOSENSOR=1 \
    -v "$SCRIPT_DIR/tweak.cfg:/openpilot/tools/gta_bridge/tweak.cfg" \
    "$IMAGE_TAG" \
