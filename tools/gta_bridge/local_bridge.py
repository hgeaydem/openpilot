#!/usr/bin/env python3
"""
Local GTA5 bridge - runs bridge + companion on the same machine.
...
def main():
    parser = argparse.ArgumentParser(
        description='GTA5 local bridge (single machine, screen capture)',
    )
    ...
    parser.add_argument('--telemetry-port', type=int, default=5557,
                        help='UDP port for GTA5 telemetry (default: 5557)')
