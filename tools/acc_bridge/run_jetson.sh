#!/bin/bash
# Launch the ACC bridge container on NVIDIA Jetson.
#
# Usage:
...
#   IMAGE_TAG      - Docker image tag (default: acc-bridge-l4t)
...
IMAGE_TAG="${IMAGE_TAG:-acc-bridge-l4t}"
...
echo "Starting ACC bridge on Jetson..."
...
exec docker run -it --rm \
    ...
    -e SIMULATION=1 \
    -e NOSENSOR=1 \
    -v "$SCRIPT_DIR/tweak.cfg:/openpilot/tools/acc_bridge/tweak.cfg" \
    "$IMAGE_TAG" \
